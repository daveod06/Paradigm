...
class ribbon_##NUM : para_ribbon_base\
{\
...
class para_RscPicture: para_RscText
{
	style = "0x30";
};
class para_RscPictureKeepAspect: para_RscPicture
{
...
class para_RscStructuredText_c: para_RscStructuredText
{
	class Attributes
	{
		align = "center";
...
class para_RscStructuredText_r: para_RscStructuredText
{
	class Attributes
	{
		align = "right";
...
class para_RscControlsGroupNoScrollbarHV : para_RscControlsGroup
{
	class VScrollbar
	{
		width = 0;
...
class para_RscControlsGroupNoScrollbarH : para_RscControlsGroup
{
	class HScrollbar
	{
		height = 0;
...
class para_RscControlsGroupNoScrollbarV : para_RscControlsGroup
{
	class VScrollbar
	{
		width = 0;
...
class para_ribbon_base: para_RscButton_ImgSwitch
{
	idc = -1;
	...
	onMouseEnter = "[_this#0,true] call VN_TEST_FNC_CtrlEH_enter;";
	onMouseExit = "call VN_TEST_FNC_CtrlEH_exit;";
	onButtonClick = "[_this#0,true]call VN_TEST_FNC_ctrlEH_setIcon;";
};
...
class para_RscCheckBox
{
	...
	colorPressed[]={0.1,0.1,0.1,0.9};
	colorDisabled[]={0.1,0.1,0.1,0.9};
	colorBackground[]={0,0,0,0};
...
class para_RscStatProgress : para_RscProgress
{
	style = 1;
	colorFrame[] = {0,0,0,1};
	colorBar[] = {1,1,1,1};
...
class para_RscStatProgressHUD : para_RscProgress
{
	style = 0;
	colorFrame[] = {0,0,0,0};
};
// custom UI stuff for armor stats
class para_RscCustomProgress : para_RscProgress
{
	style = 0;
	texture = "";
	textureExt = "";
...
class para_RscTotalArmorProgress : para_RscProgress
{
	style = 0;
	texture = "";
	textureExt = "";
...
//Wheelmenu - Baseclass
class para_wheelMenu_base : para_RscPicture
{
	idc = -1;
	style = "0x30";
...
// loading screen
class para_loadingScreen
{
	idd = -1;
	onLoad = "uiNamespace setVariable ['para_loadingScreen',_this select 0]";
	onUnload = "uiNamespace setVariable ['para_loadingScreen',displayNull]";
	duration = 10e10;
	fadein = 0;
	fadeout = 0;
	name = "loading screen";
	class controls
	{
		class LoadingProgress: para_RscProgress
		{
			style = 0;

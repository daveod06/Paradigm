/*
    ...
    Description:
        Rewrite of BIS Dynamic Group system. 
        Original code from - BIS_fnc_DynamicGroups
...
//Common Includes
#include "..\..\configs\ui\dynamicGroups\ui_dg_def_base.hpp"
#include "..\..\configs\ui\dynamicGroups\ui_dg_def_idc.hpp"
...
switch (_mode) do
{
    ...
    case "Initialize" :
    {
        ...
        PARA_C_DYNAMICGROUPS_ON_CLIENT_MESSAGE_VAR addPublicVariableEventHandler [missionnamespace,
        {
            ["OnClientMessage", _this] call GROUPS;
        }];

        // Initialized flag
        missionNamespace setVariable [PARA_C_DYNAMICGROUPS_INITIALIZED_VAR, true, PARA_C_DYNAMICGROUPS_IS_PUBLIC];

        // Group unit count limit
        if (_maxUnitsPerGroup < 99) then
        {
            missionNamespace setVariable [PARA_C_DYNAMICGROUPS_MAX_UNITS_PER_GROUP_VAR, _maxUnitsPerGroup, PARA_C_DYNAMICGROUPS_IS_PUBLIC];
        };
        ...
        {
            missionNamespace setVariable [PARA_C_DYNAMICGROUPS_MINIMAL_INTERACTION_VAR, _minimalInteraction, PARA_C_DYNAMICGROUPS_IS_PUBLIC];
        };

        // The forced insignia if any
        if (_forcedInsignia != "") then
        {
            missionNamespace setVariable [PARA_C_DYNAMICGROUPS_FORCED_INSIGNIA_VAR, _forcedInsignia, PARA_C_DYNAMICGROUPS_IS_PUBLIC];
        };
    ...
    case "Terminate" :
    {
        ...
        // Public variables
        missionNamespace setVariable [PARA_C_DYNAMICGROUPS_INITIALIZED_VAR, nil, PARA_C_DYNAMICGROUPS_IS_PUBLIC];
    ...
    case "IsInitialized" :
    {
        missionNamespace getVariable [PARA_C_DYNAMICGROUPS_INITIALIZED_VAR, false];
    };
    ...
    case "RegisterGroup" :
    {
        ...
        if (!isNull _group && {!isNull _leader} && {_leader == leader _group}) then
        {
            ...
            // Flag as registered
            _group setVariable [PARA_C_DYNAMICGROUPS_GROUP_REGISTERED_VAR, true, PARA_C_DYNAMICGROUPS_IS_PUBLIC];

            // Set the creator of this group
            _group setVariable [PARA_C_DYNAMICGROUPS_GROUP_CREATOR_VAR, _leader, PARA_C_DYNAMICGROUPS_IS_PUBLIC];

            // Set random insignia
            _group setVariable [PARA_C_DYNAMICGROUPS_GROUP_INSIGNIA_VAR, _insignia, PARA_C_DYNAMICGROUPS_IS_PUBLIC];

            // Set lock status, unlocked by default
            _group setVariable [PARA_C_DYNAMICGROUPS_GROUP_PRIVATE_VAR, _private, PARA_C_DYNAMICGROUPS_IS_PUBLIC];

            // Set unique var
            _group setVariable [PARA_C_DYNAMICGROUPS_GROUP_VAR_VAR, format ["%1_%2_%3", _name, getPlayerUID _leader, time], PARA_C_DYNAMICGROUPS_IS_PUBLIC];
    ...
    case "UnregisterGroup" :
    {
        ...
        if (!isNull _group && {["IsGroupRegistered", [_group]] call GROUPS}) then
        {
            ...
            {
                _group setVariable [PARA_C_DYNAMICGROUPS_GROUP_REGISTERED_VAR, nil, PARA_C_DYNAMICGROUPS_IS_PUBLIC];
                _group setVariable [PARA_C_DYNAMICGROUPS_GROUP_CREATOR_VAR, nil, PARA_C_DYNAMICGROUPS_IS_PUBLIC];
                _group setVariable [PARA_C_DYNAMICGROUPS_GROUP_INSIGNIA_VAR, nil, PARA_C_DYNAMICGROUPS_IS_PUBLIC];
                _group setVariable [PARA_C_DYNAMICGROUPS_GROUP_PRIVATE_VAR, nil, PARA_C_DYNAMICGROUPS_IS_PUBLIC];
                _group setVariable [PARA_C_DYNAMICGROUPS_GROUP_VAR_VAR, nil, PARA_C_DYNAMICGROUPS_IS_PUBLIC];
            }
            else
            {
    ...
    case "IsGroupRegistered" :
    {
        ...
        _group getVariable [PARA_C_DYNAMICGROUPS_GROUP_REGISTERED_VAR, false];
    };
    ...
    case "DeleteGroup" :
    {
        ...
        {
            //["DeleteGroupLocal", [_group]] remoteExecCall ["para_c_fnc_dynamicGroups", groupOwner _group];
            [["DeleteGroupLocal", [_group]], "para_c_fnc_dynamicGroups", groupOwner _group] call BIS_fnc_mp;
        };
    };
    ...
    case "SetPrivateState" :
    {
        ...
        {
            _group setVariable [PARA_C_DYNAMICGROUPS_GROUP_PRIVATE_VAR, _state, PARA_C_DYNAMICGROUPS_IS_PUBLIC];
        };
    };
    ...
    case "KickPlayer" :
    {
        ...
        if (!isNull _group && {!isNull _leader} && {!isNull _player} && {leader group _leader == _leader} && {group _player == _group}) then
        {
            ...
            private "_kicks";
            _kicks = _player getVariable [PARA_C_DYNAMICGROUPS_KICKED_BY_VAR, []];

            // Add new id
            _kicks pushBack _group;

            // Store this event, we want to be able to see if player was kicked out of a group
            _player setVariable [PARA_C_DYNAMICGROUPS_KICKED_BY_VAR, _kicks, PARA_C_DYNAMICGROUPS_IS_PUBLIC];
        };
    };
    ...
    case "UnKickPlayer" :
    {
        ...
        if (!isNull _group && {!isNull _player} && {["WasPlayerKickedFrom", [_group, _player]] call GROUPS}) then
        {
            // The current list of group kicks this player has
            private "_kicksOld";
            _kicksOld = _player getVariable [PARA_C_DYNAMICGROUPS_KICKED_BY_VAR, []];
    ...
    case "WasPlayerKickedFrom" :
    {
        ...
        _group in (_player getVariable [PARA_C_DYNAMICGROUPS_KICKED_BY_VAR, []]);
    };
    ...
    case "GetGroupByUniqueId" :
    {
        ...
        {
            if (_id == _x getVariable [PARA_C_DYNAMICGROUPS_GROUP_VAR_VAR, ""] && {side _x == _side}) then
            {
                _group = _x;
            };
        } forEach allGroups;
    ...
    case "InitializePlayer" :
    {
        ...
        if (!isNil { _player getVariable PARA_C_DYNAMICGROUPS_INITIALIZED_VAR }) exitWith
        {
            ["InitializePlayer: Player (%1) already initialized, terminate to be able to re-initialize", _player] call BIS_fnc_error;
        };

        // Flag as initialized
        _player setVariable [PARA_C_DYNAMICGROUPS_INITIALIZED_VAR, true, PARA_C_DYNAMICGROUPS_IS_PUBLIC];
        ...
        missionNamespace setVariable [PARA_C_DYNAMICGROUPS_PLAYER_RESPAWN_KEYDOWN_VAR,
        [
            missionnamespace,
            "RscDisplayRespawnKeyDown",
            {
                ...
                if (_key in actionKeys PARA_C_DYNAMICGROUPS_UI_OPEN_KEY && {missionNamespace getVariable [PARA_C_DYNAMICGROUPS_ALLOW_INTERFACE_VAR, true]}) then
                {
                    (_this select 0) createDisplay "para_RscDisplayDynamicGroups";
                };
            }
        ] call bis_fnc_addscriptedeventhandler, PARA_C_DYNAMICGROUPS_IS_LOCAL];

        // The updating function
        missionNamespace setVariable [PARA_C_DYNAMICGROUPS_PLAYER_DRAW3D_VAR, addMissionEventHandler ["EachFrame",
        {
            private _timeLastUpdate         = missionNamespace getVariable [PARA_C_DYNAMICGROUPS_LAST_UPDATE_TIME_VAR, 0];
            private _timeNow                = time;
            private _timeSinceLastUpdate    = _timeNow - _timeLastUpdate;

            if (_timeSinceLastUpdate >= PARA_C_DYNAMICGROUPS_INTERFACE_UPDATE_DELAY) then
            {
                ...
                // Store current time
                missionNamespace setVariable [PARA_C_DYNAMICGROUPS_LAST_UPDATE_TIME_VAR, _timeNow, PARA_C_DYNAMICGROUPS_IS_LOCAL];
            };
        }], PARA_C_DYNAMICGROUPS_IS_LOCAL];
    ...
    case "TerminatePlayer" :
    {
        ...
        [missionnamespace, "RscDisplayRespawnKeyDown", missionNamespace getVariable [PARA_C_DYNAMICGROUPS_PLAYER_RESPAWN_KEYDOWN_VAR, []]] call bis_fnc_removescriptedeventhandler;

        // Stop the updating function
        removeMissionEventHandler ["EachFrame", missionnamespace getVariable [PARA_C_DYNAMICGROUPS_PLAYER_DRAW3D_VAR, -1]];
    };
    ...
    case "SendClientMessage" :
    {
        ...
        {
            missionNamespace setVariable [PARA_C_DYNAMICGROUPS_ON_CLIENT_MESSAGE_VAR, [_inMode, _inParams, player], PARA_C_DYNAMICGROUPS_IS_PUBLIC];
        };
    };
    ...
    case "AddKeyEvents" :
    {
        ...
        [_display] spawn
        {
            ...
            _varName = PARA_C_DYNAMICGROUPS_KEY_MAIN_VAR;
            ...
            if (isNull _display) then
            {
                ...
                _varName = PARA_C_DYNAMICGROUPS_KEY_VAR;
            };
            ...
            private ["_down", "_up"];
            _down   = _display displayAddEventHandler ["KeyDown", "['OnKeyDown', _this] call para_c_fnc_dynamicGroups;"];
            _up     = _display displayAddEventHandler ["KeyUp", "['OnKeyUp', _this] call para_c_fnc_dynamicGroups;"];
    ...
    case "OnKeyDown" :
    {
        ...
        if (_key in actionKeys PARA_C_DYNAMICGROUPS_UI_OPEN_KEY && !_ctrl) then
        {
            if (isNil { uiNamespace getVariable PARA_C_DYNAMICGROUPS_KEYDOWNTIME_VAR }) then
            {
                uiNamespace setVariable [PARA_C_DYNAMICGROUPS_KEYDOWNTIME_VAR, time];
                uiNamespace setVariable [PARA_C_DYNAMICGROUPS_IGNORE_INTERFACE_OPENING_VAR, nil];
            };
    ...
    case "OnKeyUp" :
    {
        ...
        uiNamespace setVariable [PARA_C_DYNAMICGROUPS_KEYDOWNTIME_VAR, nil];

        if (!_ctrl && {_key in actionKeys PARA_C_DYNAMICGROUPS_UI_OPEN_KEY} && {isNil { uiNamespace getVariable PARA_C_DYNAMICGROUPS_IGNORE_INTERFACE_OPENING_VAR }}) then
        {
            if (isNull (findDisplay PARA_C_DYNAMICGROUPS_IDD) && {missionNamespace getVariable [PARA_C_DYNAMICGROUPS_ALLOW_INTERFACE_VAR, true]}) then
            {
                ([] call BIS_fnc_displayMission) createDisplay "para_RscDisplayDynamicGroups";
            }
            else
            {
                if (isNil { uiNamespace getVariable PARA_C_DYNAMICGROUPS_HAS_FOCUS_VAR }) then
                {
    ...
    case "UpdateKeyDown" :
    {
        ...
        if (!isNil { uiNamespace getVariable  PARA_C_DYNAMICGROUPS_KEYDOWNTIME_VAR} && {count (["GetPlayerInvites", [player]] call GROUPS) > 0}) then
        {
            private ["_timestamp", "_timeHolding"];
            _timestamp      = uiNamespace getVariable PARA_C_DYNAMICGROUPS_KEYDOWNTIME_VAR;
            _timeHolding    = time - _timestamp;

            if (_timeHolding >= PARA_C_DYNAMICGROUPS_HOLD_DOWN_TIME_FOR_INVITE_ACCEPT) then
            {
                private "_invites";
                ...
                if (count _invites > 0) then
                {
                    ...
                    uiNamespace setVariable [PARA_C_DYNAMICGROUPS_IGNORE_INTERFACE_OPENING_VAR, true];

                    // Remove invite
                    ["RemoveInvite", [_group, player]] call GROUPS;

                    // Make sure group is not full
                    if (count units _group < missionNamespace getVariable [PARA_C_DYNAMICGROUPS_MAX_UNITS_PER_GROUP_VAR, 99]) then
                    {
    ...
    case "AddInvite" :
    {
        ...
        _invitations = _to getVariable [PARA_C_DYNAMICGROUPS_INVITES_VAR, []];
        ...
        // Broadcast changes
        _to setVariable [PARA_C_DYNAMICGROUPS_INVITES_VAR, _invitations, PARA_C_DYNAMICGROUPS_IS_PUBLIC];

        // Fire event on target computer
        //["OnInvitationReceived", [_group, _to, _from]] remoteExecCall ["para_c_fnc_dynamicGroups", _to];
        [["OnInvitationReceived", [_group, _to, _from]], "para_c_fnc_dynamicGroups", _to] call BIS_fnc_mp;

        // If player was kicked from group we unkick since he was invited
        //["UnKickPlayer", [_group, _to]] remoteExecCall ["para_c_fnc_dynamicGroups", 2];
        [["UnKickPlayer", [_group, _to]], "para_c_fnc_dynamicGroups", false] call BIS_fnc_mp;
    ...
    case "RemoveInvite" : {
        ...
        _invitations    = _player getVariable [PARA_C_DYNAMICGROUPS_INVITES_VAR, []];
        ...
        _player setVariable [PARA_C_DYNAMICGROUPS_INVITES_VAR, _container, PARA_C_DYNAMICGROUPS_IS_PUBLIC];
    ...
    case "GetPlayerInvites" :
    {
        ...
        _invites        = _player getVariable [PARA_C_DYNAMICGROUPS_INVITES_VAR, []];
        _validInvites   = [];
    ...
    case "OnGroupJoin" :
    {
        ...
        {
            [["LocalShowNotification", ["DynamicGroups_PlayerJoined", [name _who], _leader]], "para_c_fnc_dynamicGroups", _leader] call BIS_fnc_mp;
        };
    };
    ...
    case "OnGroupJoinFailed" :
    {
        ...
        if (!isNull _who) then
        {
            [["LocalShowNotification", ["DynamicGroups_PlayerJoinFailed", [], _who]], "para_c_fnc_dynamicGroups", _who] call BIS_fnc_mp;
        };
    };
    ...
    case "OnGroupLeave" :
    {
        ...
        if (!isNull _leader && {!isNull _who} && {_leader != _who}) then
        {
            [["LocalShowNotification", ["DynamicGroups_PlayerLeft", [name _who], _leader]], "para_c_fnc_dynamicGroups", _leader] call BIS_fnc_mp;
        };
    };
    ...
    case "OnPromotedToLeader" :
    {
        ...
        {
            [["LocalShowNotification", ["DynamicGroups_PromotedToLeader", [name _oldLeader], _newLeader]], "para_c_fnc_dynamicGroups", _newLeader] call BIS_fnc_mp;
        };
    ...
    case "OnGroupDisbanded" :
    {
        ...
        {
            [["LocalShowNotification", ["DynamicGroups_GroupDisbanded", [name _oldLeader], _who]], "para_c_fnc_dynamicGroups", _who] call BIS_fnc_mp;
        };
    ...
    case "OnKicked" :
    {
        ...
        {
            [["LocalShowNotification", ["DynamicGroups_Kicked", [name _leader], _who]], "para_c_fnc_dynamicGroups", _who] call BIS_fnc_mp;
        };
    ...
    case "OnPlayerGroupChanged" :
    {
        ...
        {
            [_player, _newGroup getVariable [PARA_C_DYNAMICGROUPS_GROUP_INSIGNIA_VAR, ""]] call BIS_fnc_setUnitInsignia;
        }
        else
        {
    ...
    case "GetGroupTexture" :
    {
        ...
        if (!isNil { uiNamespace getVariable PARA_C_DYNAMICGROUPS_AVAILABLE_INSIGNIA_VAR }) then
        {
            _availableInsignias = uiNamespace getVariable PARA_C_DYNAMICGROUPS_AVAILABLE_INSIGNIA_VAR;
        }
        else
        {
        ...
        private _lastInsigniaTexture = _group getVariable [PARA_C_DYNAMICGROUPS_LAST_INSIGNIA_VAR, ""];
        ...
        if (_lastInsigniaTexture == "") then
        {
            ...
            private _groupPicture 	= leader _group getVariable [PARA_C_DYNAMICGROUPS_INITIALIZED_VAR, _insignia];
            _insigniaTexture = ["GetInsigniaTexture", [_groupPicture]] call para_c_fnc_dynamicGroups;
            _group setVariable [PARA_C_DYNAMICGROUPS_LAST_INSIGNIA_VAR, _insigniaTexture];
        }
        else
        {
    ...
    {
        uiNamespace setVariable [PARA_C_DYNAMICGROUPS_AVAILABLE_INSIGNIA_VAR, _params param [0, [], [[]]]];
    };

    case "GetAvailableInsignias" :
    {
        uiNamespace getVariable [PARA_C_DYNAMICGROUPS_AVAILABLE_INSIGNIA_VAR, []];
    };

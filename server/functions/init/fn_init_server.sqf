...
[] spawn {
	private _fnc_initServer = compile preprocessFile "coreFunctions\para_server_init.sqf";
	//private _fnc_serverCode = compile preprocessFile "coreFunctions\para_server_init.sqf"; // FIXME - make per mission type
	...
	//[] call _fnc_serverCode; // FIXME - make per mission type
